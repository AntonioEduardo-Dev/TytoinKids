...
$(function () {
    ...
    $.get('commandscontrol/new/Produtos.php', listarCategorias, function (retorna) {
    ...
    $.get('commandscontrol/new/Produtos.php', listarCategoriasFilter, function (retorna) {
        var objCategFilter = jQuery.parseJSON(retorna);
        var content = ``;
    ...
    $.get('commandscontrol/new/Produtos.php', listarProdutos, function (retorna) {
