...
$(function () {
    ...
    if (url = url_atual.split("?id=")) {
        if (url[1]) {
            ...
            $.get('commandscontrol/new/Produtos.php', listarProduto, function (retorna) {
                ...
                if (dados_produto.type == "success") {
                    ...
                    $("#id_categoria_produto").html((produto.id_categoria_fk == 0 || produto.id_categoria_fk == null ? 'Sem categoria' : produto.id_categoria_fk));
                } else {
                    location.href = 'loja';
                }
            });
    ...
    $(document).on('click', '.addToCart', function () {
        ...
        if (id_produto != 0 && id_produto > 0) {
            ...
            $.get('commandscontrol/new/Encomendas.php', produtoCarrinho, function (retorna) {
