        ...
        if (url[1]) {
            ...
            $.post('commandscontrol/Produtos.php', listarProduto, function(retorna) {
                ...
                if (values[0] == null || values[0] == "" || values[0] < 1) {
                    ...
                    $("#imagem_produto").attr('src', (values[4] == "" || values[4] == null || values[4] == "productind.jpg" ? 'commandsview/assets/img/images/productind.jpg' : 'commandsview/assets/img/images/'+values[4]));
