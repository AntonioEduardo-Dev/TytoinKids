<?php include_once "commandsview/includes/header.php";?>
			...
			<div class="row">
				<div class="col-lg-7">
					<div class="featured-text">
						<h2 class="pb-3">Por que <span class="orange-text">Tytoin</span></h2>
						<div class="row">
	...
	<section class="shop-banner">
    	<div class="container">
            ...
            <a href="loja" class="cart-btn btn-lg">Compre agora</a>
        </div>
    </section>
	<!-- end shop banner -->
			...
			<div class="row mt-5 mb-5">
				<div class="col-lg-10 offset-lg-1 text-center">
					<div class="testimonial-sliders">
						...
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="commandsview/assets/img/team/avatar3.png" alt="">
							</div>
							<div class="client-meta">
