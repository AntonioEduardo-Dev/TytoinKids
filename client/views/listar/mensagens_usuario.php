						...
						<div class="col col-md-12"> 
							<div class="cart-table-wrap">
								<table class="cart-table" id="table_dinamic_js">
									...
									<input type="text" id="id_msg" value="<?php echo ((isset($_SESSION["user"]) && $_SESSION["user"]["tipo_user"] != "convidado") ? $_SESSION["user"]["id"] : ""); ?>" disabled hidden>
								</table>
							</div>
						</div>
					</div>
...
<script src="client/functions/read/listar_mensagens.js"></script>