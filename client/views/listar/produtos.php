<?php include_once "client/views/includes/header.php";?>
	...
	<div class="row mt-5 ">
		<div class="col-md-2 offset-md-5 text-center">
			<a href="cadastrar/cadastrar_produto">
...
<!-- listar Produtos js -->
<script src="client/functions/read/scriptDataTableProdutos.js"></script>
<!-- função Modal js -->
<script src="client/functions/content/conteudoModal.js"></script>
<!-- editar/apagar Produtos js -->
<script src="client/functions/update_delete/produto.js"></script>
<!-- função Modal js -->
