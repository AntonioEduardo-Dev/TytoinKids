			...
			<div class="row">
				<div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
					<div class="list-box d-flex align-items-center">
						...
						<div class="content">
							<h3>Frete grátis</h3>
							<p>Quando o pedido for superior a $ 75</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
				...
				<div class="col-lg-4 col-md-6">
					<div class="list-box d-flex justify-content-start align-items-center">
						...
						<div class="content">
							<h3>Reembolso</h3>
							<p>Obtenha reembolso dentro de 3 dias!</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="produto"><img src="client/views/assets/img/images/product-01-view.jpg" alt=""></a>
						</div>
						<h3>Vestido 1</h3>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="produto"><img src="client/views/assets/img/images/product-02-view.jpg" alt=""></a>
						</div>
						<h3>Vestido 2</h3>
				...
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="produto"><img src="client/views/assets/img/images/product-03-view.jpg" alt=""></a>
						</div>
						<h3>Vestido 3</h3>
					...
					<div class="testimonial-sliders">
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="client/views/assets/img/team/avatar1.png" alt="">
							</div>
						...
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="client/views/assets/img/team/avatar2.png" alt="">
							</div>
							<div class="client-meta">
	...
	<div class="abt-section mb-150">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						<p class="top-sub">Desde o ano de 2010</p>
