										...
										if (isset($_SESSION["cart"])){
											foreach ($_SESSION['cart'] as $key => $value) {
												echo '<tr class="table-body-row">
															<td class="product-image"><img src="client/views/assets/img/images/'.$value["imgProduto"].'" alt="'.$value["imgProduto"].'"></td>
...
<!-- conteudo modal js -->
<script src="client/functions/content/conteudoCart.js"></script>
<!-- inserir produtos js -->
<script src="client/functions/create/insertOrder.js"></script>
<!-- função Modal js -->
